...
class Setting(models.TransientModel):
    ...
    def get_values(self):
        ...
        res.update(
            ...
            enable_creation=self.env['ir.config_parameter'].sudo().get_param('car_model.enable_creation', default=False)
        )
        return res
    ...
    def set_values(self):
        ...
        self.env["ir.config_parameter"].sudo().set_param('car_model.enable_creation', self.enable_creation)